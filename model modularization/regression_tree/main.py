...
from model_regression_tree import build_regression_tree
...
# plot
predict.my_self(testY_inv, testPred_inv, 'Regression tree')
predict.score_calculation(testY_inv, testPred_inv)
predict.plot_pred(testY_inv, testPred_inv, 'Regression tree')
predict.plot_residuals(testY_inv, testPred_inv, 'Regression tree')
